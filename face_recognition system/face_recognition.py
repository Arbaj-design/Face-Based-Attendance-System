...
class Face_recognition:
    def __init__(self,root):
        ...
        #1st image
        img_top=Image.open(r"images\download1.jpg")
        img_top=img_top.resize((650,700),Image.ANTIALIAS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=5,y=50,width=650,height=700) 

        #2nd image
        img_top=Image.open(r"images\download.jpg")
        img_top=img_top.resize((650,700),Image.ANTIALIAS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=655,y=50,width=650,height=700) 
        ...
        b1_1.place(x=215,y=590,width=210,height=40)

    #========================attendance====================
    def mark_attendance(self,i,r,n,d):
        with open("avaiz.csv", "r+", newline="\n") as f:
