...
class Train:
    def __init__(self,root):
        ...
        b1_1.place(x=90,y=380,width=1200,height=60)

        img_bottom=Image.open(r"face_recognition system\images\train_page_photo2.jpg")
        img_bottom=img_bottom.resize((1366,325),Image.ANTIALIAS)
