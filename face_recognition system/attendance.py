...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"face_recognition system\images\final-logo.png") #smartattendance.jpg #geca logo should be paste here and at photo 3 as well
        img=img.resize((1366,150),Image.ANTIALIAS)
        self.photoimg=ImageTk.PhotoImage(img)

        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=1366,height=150)

        #Second image
        img1=Image.open(r"face_recognition system\images\face.jpg")   #clg.jpg
        ...
        bg_img.place(x=0,y=150,width=1366,height=648)
        ...
        left_inside_frame.place(x=0,y=125,width=650,height=380)
        ...
        atten_roll=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_roll,font="comicsandns 11 bold")
        ...
        atten_name=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_name,font="comicsandns 11 bold")
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_dep,font="comicsandns 11 bold")
        ...
        atten_time=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_time,font="comicsandns 11 bold")
        ...
        atten_date=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_date,font="comicsandns 11 bold")
        ...
        btn_frame.place(x=0,y=290,width=640,height=50)
        ...
        table_frame.place(x=5,y=5,width=620,height=445)
